...
SM_MAP_DEFINE(SMVM_SyscallMap,char *,const char * const,SMVM_Syscall,fnv_16a_str(key),SMVM_SyscallMap_key_equals,SMVM_SyscallMap_key_less_than,SMVM_SyscallMap_key_copy,free,malloc,free,)
